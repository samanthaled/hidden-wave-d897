...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hidden-wave-d897)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-wave-d897
```

A live public deployment of this template is available at [https://hidden-wave-d897.templates.workers.dev](https://hidden-wave-d897.templates.workers.dev)
